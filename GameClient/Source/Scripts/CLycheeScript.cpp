...
CLycheeScript::CLycheeScript()
	: CCookieSkillScript(SCRIPT_TYPE::LYCHEESCRIPT)
...
// 스킬 해제 시 호출
void CLycheeScript::OnUnequip()
{
	EndSkill();
}

void CLycheeScript::Begin()
{
...
bool CLycheeScript::CanAutoUseSkill() const
{
...
void CLycheeScript::EnterSkillMode()
{
	if (m_Player == nullptr)
		return;
...
void CLycheeScript::ExitSkillMode()
{
	if (m_Player == nullptr)
		return;
...
void CLycheeScript::TrySpawnSlideEffect()
{
...
void CLycheeScript::SpawnTKBGEffect(int _LayerIdx)
{
...
void CLycheeScript::DestroyTKBGEffect()
{
...
void CLycheeScript::UpdateSkillMove()
{
	if (m_Player == nullptr)
		return;
...
void CLycheeScript::UpdateSkillScore()
{
...
// 스킬 애니메이션 상태 업데이트
void CLycheeScript::UpdateSkillAnimState()
{
...
void CLycheeScript::ChangeSkillState(ESkillState _NextState)
{
...
void CLycheeScript::PlaySkillAnim(ESkillState _AnimState)
{
